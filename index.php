    ...
    <div>
      ...
      <section>
        <aside >
          <ul>
             <li>
               <a href="bmwe30.html">BMW e30 1988</a>
             </li>
             <li>
                <a href="bmw.html">BMW e30 1990</a>
             </li>
             <li>
                <a href="e30.html">BMW e30 1991</a>
             </li>
             <li>
                <a href="m3.html">BMW e30 M3</a>
             </li>
          </ul>
             <img src="img/logo.jpg" width="200"/>
            <img src="img/benka.jpg" width="200"/>
            <img src="img/logic.jpg" width="200"/>


        </aside>
        <article>
          <h1>Changes from the standard 3-series</h1>
          <iframe width="980" height="540" src="https://www.youtube.com/embed/aRtY3Tg9yJg?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          <h2>Body</h2>
          <p>
...
Wrap up
<br/>
          <img src="img/slika.jpg" width="450"/>
          <img src="img/e30.jpg" width="500"/>
        </article>
      </section>
      <footer>
        zivac ©2015
